...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(string movieGenre, string movieReleaseDate, string searchString)
        {
            ...
            {
                movies = movies.Where(x => x.ReleaseDate.Year.ToString() == movieReleaseDate);
            }
